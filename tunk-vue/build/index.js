...
/******/ 	var hotCurrentHash = "d9cd74c2a58440634a1b"; // eslint-disable-line no-unused-vars
...
exports.default = [{ path: '/', text: '' }, { path: '/counter', text: 'Counter' }, { path: '/todo', text: 'Todo' }];
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(42), __webpack_require__(43), __webpack_require__(71).setImmediate))
...
var _tunk = __webpack_require__(15);
...
var increment = (_class = function () {
  ...
  return increment;
}(), (_applyDecoratedDescriptor(_class.prototype, 'increment', [_tunk.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'increment'), _class.prototype)), _class);
...
var _tunkVue = __webpack_require__(75);

var _tunkVue2 = _interopRequireDefault(_tunkVue);

var _tunkDebug = __webpack_require__(76);

var _tunkDebug2 = _interopRequireDefault(_tunkDebug);

var _tunkRequest = __webpack_require__(77);
...
_tunk2.default.config({
	debug: ['store', 'getState']
}).use([_tunkVue2.default, _tunkDebug2.default, (0, _tunkRequest2.default)({})]);

_vue2.default.use(_vueRouter2.default);
_vue2.default.use(_tunk2.default);

var modules_ = __webpack_require__(82);
modules_.keys().forEach(function (item) {
	modules_(item);
});

var routes_ = JSON.parse((0, _stringify2.default)(_route2.default));
...
var __WEBPACK_AMD_DEFINE_RESULT__;(function(){
    ...
    if (typeof module === 'object' && module.exports) {
        ...
        !(__WEBPACK_AMD_DEFINE_RESULT__ = (function () { return apply }).call(exports, __webpack_require__, exports, module),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))
    }
...
Component.options.__file = "/Users/mac/source/examples/tunk-vue/src/Main.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Main.vue: functional components are not supported with templates, they should use render functions.")}

/* hot reload */
if (true) {(function () {
  var hotAPI = __webpack_require__(44)
  hotAPI.install(__webpack_require__(41), false)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8d8ecd44", Component.options)
  } else {
    hotAPI.reload("data-v-8d8ecd44", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('section', [_c('ul', _vm._l((_vm.route), function(item, index) {
    return _c('li', {
      key: index
    }, [(item.text) ? _c('router-link', {
      attrs: {
        "to": item.path
      }
    }, [_vm._v(" " + _vm._s(item.text) + " ")]) : _vm._e()], 1)
  })), _vm._v(" "), _c('section', [_c('router-view')], 1)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(44).rerender("data-v-8d8ecd44", module.exports)
  }
}
...
var map = {
	"./counter/_increment.js": 45,
	"./counter/counter.js": 89,
	"./route.js": 21,
	"./todo/todo.js": 137
};
...
var _increment3 = __webpack_require__(45);

var _increment4 = _interopRequireDefault(_increment3);
...
var counter = (0, _tunk.create)(_class = (_class2 = function (_increment2) {
  (0, _inherits3.default)(counter, _increment2);
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt('return', { count: this.state.count - 1 });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return new _promise2.default(function (resolve, reject) {
                  setTimeout(function () {
                    _this2.dispatch('decrement');
                    resolve(_this2.state.count - 1);
                  }, 1000);
                });

              case 2:
                count = _context2.sent;
                return _context2.abrupt('return', { count: count });
  ...
  return counter;
}(_increment4.default), (_applyDecoratedDescriptor(_class2.prototype, 'decrement', [_tunk.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'decrement'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'decrementAsync', [_tunk.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'decrementAsync'), _class2.prototype)), _class2)) || _class;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(13)(Function.call, __webpack_require__(24).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var todo = (0, _tunk.create)(_class = (_class2 = function () {
	...
	(0, _createClass3.default)(todo, [{
						...
						switch (_context2.prev = _context2.next) {
							case 0:
								...
								return new _promise2.default(function (resolve) {
									setTimeout(function () {
										var list = window.localStorage['todoList'] ? JSON.parse(window.localStorage['todoList']) : [_this.make()];
										resolve(list);
									}, 2000);
								});
		...
		key: 'saveToStorage',
		value: function saveToStorage(list) {
			list = list || this.state.list;
			window.localStorage['todoList'] = (0, _stringify2.default)(list);
		}
	}, {
		key: 'make',
		value: function make(text) {
			return {
	...
	return todo;
}(), (_applyDecoratedDescriptor(_class2.prototype, 'getList', [_tunk.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'getList'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'change', [_tunk.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'change'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'add', [_tunk.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'add'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'del', [_tunk.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'del'), _class2.prototype)), _class2)) || _class;
